...
ggplot(Food_pound,aes(x= year,y=foodof))+geom_line(size=1.5,col="red")+labs(x = "year",y = "food supply",title = "Food supply")+theme_bw()
ggplot(Food_pound,aes(x = year, y = people))+geom_line(size=1.5,col="red")+labs(x = "year",y = "Client Amount",title = "Food supply")+theme_bw()+theme_grey()
ggplot(Food_pound,aes(x = year, y = food.ave))+geom_line(size=1.5,col="red")+labs(x = "year",y = "Average Food",title = "Food supply")+theme_bw()+theme_grey()
...
#Actually it is not affected by the season.
...
I am going to explore some other variables in the final project.
